      ...
      drawer: Drawer(
        ...
        child: SafeArea(
          child: Container(
            ...
            decoration: BoxDecoration(color: Color.lerp(Colors.black,Colors.white,0.15),borderRadius: BorderRadius.only(topLeft: Radius.circular(10),topRight: Radius.circular(10))),
