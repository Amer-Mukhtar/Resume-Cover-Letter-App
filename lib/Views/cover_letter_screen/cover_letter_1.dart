...
class _CoverState extends State<Cover> {
  ...
  Widget build(BuildContext context) {
    final viewModel = Provider.of<CoverViewModelProvider>(context, listen: false);
    return Scaffold(
      ...
      body: viewModel.coverLetters.isEmpty
          ? Container(
        ...
        shrinkWrap: true,
        itemCount: viewModel.coverLetters.length,
        itemBuilder: (context, index) {

          final item = viewModel.coverLetters[index];

          return GestureDetector(
            onTap: () {
              _showCoverLetterOptions(context, index, viewModel);
            },
            child: Container(
