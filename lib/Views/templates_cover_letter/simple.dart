  ...
  pdf.addPage(
    pw.MultiPage(
      ...
      build: (pw.Context context) {
        ...
        return[
         pw.Container(
             margin: const pw.EdgeInsets.only(left: 30,right: 30,top: 50,bottom: 10),child: pw.Column(
           crossAxisAlignment: pw.CrossAxisAlignment.start,
           children: [
             pw.Container(child: pw.Text(Clmodel.firstName.toString().toUpperCase(),style: const pw.TextStyle(fontSize: 50))),

             pw.Container(child: pw.Text(Clmodel.lastName.toString().toUpperCase(),style: const pw.TextStyle(fontSize: 50))),
           ]
         )),
          pw.Container(margin: const pw.EdgeInsets.symmetric(horizontal: 35,vertical: 20),
            child: pw.Row(mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,children: [

            pw.Container(child: pw.Text(Clmodel.email.toString(),style: const pw.TextStyle(fontSize: 20))),

            pw.Container(child: pw.Text(Clmodel.phoneNumber.toString(),style: const pw.TextStyle(fontSize: 20))),

            pw.Container(child: pw.Text(Clmodel.address.toString(),style: const pw.TextStyle(fontSize: 20))),
         ...
         pw.Container(
           margin: const pw.EdgeInsets.symmetric(horizontal: 30,vertical: 25),
             constraints: const pw.BoxConstraints(maxWidth: 515),
             child: pw.Text(Clmodel.summary.toString(),style: const pw.TextStyle(fontSize: 16))
         ),

          pw.Container(
              margin: const pw.EdgeInsets.symmetric(horizontal: 35),
              child: pw.Text("Best Regards",style: const pw.TextStyle(fontSize: 16))
          ),
          pw.Container(
              margin: const pw.EdgeInsets.symmetric(horizontal: 35),
              child: pw.Text("${Clmodel.firstName} ${Clmodel.lastName}",
