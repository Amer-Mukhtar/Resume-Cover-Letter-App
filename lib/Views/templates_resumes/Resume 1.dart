...
Future createPdf_B_W(ResumeModel resumeModel, String action,BuildContext context) async
{
  ...
  final ByteData address = await rootBundle.load('assets/icons/address.png');
  address0 = address.buffer.asUint8List();

  final ByteData envelope = await rootBundle.load('assets/icons/envelope.png');
  envelope0 = envelope.buffer.asUint8List();

  final ByteData phoneBW = await rootBundle.load('assets/icons/phoneBW.png');
  phoneBW0 = phoneBW.buffer.asUint8List();


  final ByteData dot = await rootBundle.load('assets/icons/dot_black.png');
  dot0 = dot.buffer.asUint8List();


  final ByteData bottomLeftData = await rootBundle.load('assets/images/bottom_left.png');
  bottomLeft = bottomLeftData.buffer.asUint8List();

  final ByteData topLeftData = await rootBundle.load('assets/images/top_left.png');
  topLeft = topLeftData.buffer.asUint8List();

  final ByteData topRightData = await rootBundle.load('assets/images/top_right.png');
  topRight = topRightData.buffer.asUint8List();
