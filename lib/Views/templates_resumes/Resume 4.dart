                    ...
                    child: pw.ConstrainedBox(
                        child: pw.Column(
                          ...
                          children: [
                            ///Contact/////////////
                           pw.Container(
                               margin: const pw.EdgeInsets.only(left: -20,top: -20),
                             padding: const pw.EdgeInsets.only(left: 20,top: 28,bottom: 28),
                             color: PdfColors.white,
                             child: pw.Row(children: [
                              pw.Container(padding: const pw.EdgeInsets.all(10),color: PdfColors.grey,child:  pw.Column(children: [
                                pw.Container(
                                  width: 14,
                                  height: 12,
                                  child: pw.Image(
                  ...
                  children: [
                    ...
                    pw.Container(
                      margin: const pw.EdgeInsets.only(top: 40),
                        ...
                        [
                          pw.Column(
                            children: [pw.Container(margin: const pw.EdgeInsets.only(left: -20,right: 10),color: PdfColors.grey,width: 0.5,height: 60)]
                          ),
