    ...
    pw.MultiPage(
      ...
      build: (pw.Context context) {
        ...
        return[
         ...
         pw.Container(padding: const pw.EdgeInsets.only(top: 70),child:  pw.Row(
         ...
         pw.Container(margin: const pw.EdgeInsets.symmetric(horizontal: 30),child:  pw.Divider(thickness: 0.5,color: PdfColors.black),),
          ...
          //summary
          pw.Container(margin: const pw.EdgeInsets.only(top: 10,bottom: 10,left: 30,right: 30),constraints: const pw.BoxConstraints(maxWidth: 315),child: pw.Text(newResumeModel.intro!.summary)),
          pw.SizedBox(height: 20),
          pw.Row(
            children: [
              pw.SizedBox(width: 10),
              pw.Container(margin: const pw.EdgeInsets.symmetric(horizontal: 30),child: pw.Text('Area of Expertise',style: LBText),)
            ]
          ),
          pw.Container(margin: const pw.EdgeInsets.symmetric(horizontal: 30),child:  pw.Divider(thickness: 0.5,color: PdfColors.black),),
          ...
          pw.Row(
              children: [
                pw.SizedBox(width: 10),
                pw.Container(margin: const pw.EdgeInsets.symmetric(horizontal: 30),child: pw.Text('KEY ACHIEVEMENTS',style: LBText),)
              ]
          ),
          pw.Container(margin: const pw.EdgeInsets.symmetric(horizontal: 30),child:  pw.Divider(thickness: 0.5,color: PdfColors.black),),
          pw.Container(
          ...
          pw.Row(
              children: [
                pw.SizedBox(width: 10),
                pw.Container(margin: const pw.EdgeInsets.symmetric(horizontal: 30),child: pw.Text('Professional Experience',style: LBText),)
              ]
          ),
          pw.Container(margin: const pw.EdgeInsets.symmetric(horizontal: 30),child:  pw.Divider(thickness: 0.5,color: PdfColors.black),),
          pw.Container(
          ...
          pw.Row(
              children: [
                pw.SizedBox(width: 10),
                pw.Container(margin: const pw.EdgeInsets.symmetric(horizontal: 30),child: pw.Text('Education',style: LBText),)
              ]
          ),
          pw.Container(margin: const pw.EdgeInsets.symmetric(horizontal: 30),child:  pw.Divider(thickness: 0.5,color: PdfColors.black),),
          ...
          pw.ListView.builder(
            ...
            itemBuilder: (context, index)
            {
              ...
              return pw.Container(margin: const pw.EdgeInsets.symmetric(horizontal: 30),
                  child: pw.Column(
                crossAxisAlignment: pw.CrossAxisAlignment.start,
                children: [
                  pw.Row(
          ...
          pw.Row(
              children: [
                pw.SizedBox(width: 10),
                pw.Container(margin: const pw.EdgeInsets.only(left: 30,right: 30,top: 20),child: pw.Text('Additional Information',style: LBText),)
              ]
          ),
          pw.Container(margin: const pw.EdgeInsets.symmetric(horizontal: 30),child:  pw.Divider(thickness: 0.5,color: PdfColors.black),),
pw.Container(margin: const pw.EdgeInsets.symmetric(horizontal: 30),child:pw.Row(
  crossAxisAlignment: pw.CrossAxisAlignment.start,
  mainAxisAlignment:pw.MainAxisAlignment.start,
  children: [
    ...
    pw.Container(
      ...
      child: pw.Wrap(
        ...
        children: List.generate(
          ...
          pw.Container(margin: const pw.EdgeInsets.symmetric(horizontal: 30),child: pw.Row(crossAxisAlignment: pw.CrossAxisAlignment.start,
